{
  description = "squish - SquashFS archive management tool";
  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        # Read Python version from .python-version file (strip newline)
      ...
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "squish development environment loaded"
